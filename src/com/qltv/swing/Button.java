...
public class Button extends JButton {
    ...
    private Color shadowColor = new Color(218,170,102);
    private BufferedImage imageShadow;
    private final Insets shadowSize = new Insets(2, 5, 8, 5);
    private final RippleEffect1 rippleEffect = new RippleEffect1(this);
    ...
    public Button() {
        ...
        rippleEffect.setRippleColor(new Color(102,102,255));
    }
